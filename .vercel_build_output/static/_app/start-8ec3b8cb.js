...
var G = (i, t, e) =>
    t in i
      ? at(i, t, { enumerable: !0, configurable: !0, writable: !0, value: e })
      : (i[t] = e),
  R = (i, t) => {
    for (var e in t || (t = {})) J.call(t, e) && G(i, e, t[e]);
    if (N) for (var e of N(t)) W.call(t, e) && G(i, e, t[e]);
    return i;
  },
  X = (i, t) => ot(i, lt(t));
var x = (i, t) => {
  var e = {};
  for (var s in i) J.call(i, s) && t.indexOf(s) < 0 && (e[s] = i[s]);
  if (i != null && N)
    for (var s of N(i)) t.indexOf(s) < 0 && W.call(i, s) && (e[s] = i[s]);
  return e;
};
import {
  S as ct,
...
function $t(i) {
  ...
  return {
    c() {
      t && U(t.$$.fragment), (e = wt()), l && l.c(), (s = y());
    },
    l(c) {
      t && H(t.$$.fragment, c), (e = bt(c)), l && l.l(c), (s = y());
    },
    m(c, u) {
    ...
    p(c, [u]) {
      ...
      if (
        (u & 525 && (h.$$scope = { dirty: u, ctx: c }), n !== (n = c[0][0]))
      ) {
        if (t) {
          T();
          const f = t;
...
const qt = "modulepreload",
          ...
          e.map((s) => {
            ...
            if (
              ...
              return new Promise((o, l) => {
                n.addEventListener("load", o), n.addEventListener("error", l);
              });
          })
        ).then(() => t());
  },
  S = [
    () =>
      V(
        () => import("./pages/__layout.svelte-5c6ea3af.js"),
        [
          "pages/__layout.svelte-5c6ea3af.js",
          "assets/pages/__layout.svelte-a8a270e2.css",
          "chunks/vendor-812880e1.js",
        ]
      ),
    () =>
      V(
        () => import("./error.svelte-3715428d.js"),
        ["error.svelte-3715428d.js", "chunks/vendor-812880e1.js"]
      ),
    () =>
      V(
        () => import("./pages/index.svelte-6bf74c5b.js"),
        [
          "pages/index.svelte-6bf74c5b.js",
          "assets/pages/index.svelte-27b5df92.css",
          "chunks/vendor-812880e1.js",
        ]
      ),
    () =>
      V(
        () => import("./pages/about.svelte-1e54c5b6.js"),
        [
          "pages/about.svelte-1e54c5b6.js",
          "assets/pages/about.svelte-206e1d16.css",
          "chunks/vendor-812880e1.js",
        ]
      ),
  ],
...
class jt {
  ...
  init_listeners() {
    ...
    addEventListener("touchstart", e),
      ...
      addEventListener("click", (a) => {
        ...
        const c = (n.getAttribute("rel") || "").split(/\s+/);
        if (
  ...
  async goto(
    ...
    return this.enabled && this.owns(o)
      ? (history[s ? "replaceState" : "pushState"](a, "", t),
        this._navigate(o, e ? z() : null, r, n, o.hash))
  ...
  async _navigate(t, e, s, r, a) {
    ...
    await this.renderer.handle_navigation(n, r, !1, {
      hash: a,
      scroll: e,
      keepfocus: s,
    }),
...
function Vt(i, t) {
  ...
  t && typeof t.body == "string" && (s += `[data-body="${Ct(t.body)}"]`);
...
class Dt {
  ...
  async update(t, e, s, r) {
    ...
    if (
      ...
      if (p === Math.min(f, k) || b - f == k - p) {
        const L = c && document.getElementById(c.slice(1));
        u ? scrollTo(u.x, u.y) : L ? L.scrollIntoView() : scrollTo(0, 0);
      }
    } else await 0;
  ...
  async _get_navigation_result(t, e) {
    ...
    for (let s = 0; s < t.routes.length; s += 1) {
      ...
      const n = await this._load({ route: r, info: t }, e);
      if (n) return n;
    }
  ...
  async _load_node({ status: t, error: e, module: s, page: r, stuff: a }) {
    ...
    for (const c in r.params)
      Object.defineProperty(o, c, {
        get() {
          return n.uses.params.add(c), r.params[c];
        },
        enumerable: !0,
      });
    ...
    t: for (let d = 0; d < l.length; d += 1) {
      ...
      try {
        ...
        if (
          ...
          w !== g.module ||
          (f.path && g.uses.path) ||
          f.params.some((q) => g.uses.params.has(q)) ||
          (f.query && g.uses.query) ||
          (f.session && g.uses.session) ||
          g.uses.dependencies.some((q) => this.invalid.has(q)) ||
          (D && g.uses.stuff)
        ) {
          _ = await this._load_node({ module: w, page: b, stuff: k });
          const q = d === l.length - 1;
          if (_ && _.loaded) {
            if (
              (_.loaded.error && ((L = _.loaded.status), (P = _.loaded.error)),
              _.loaded.redirect)
            )
              return {
...
async function Bt({
  ...
  const l = new Dt({ Root: Lt, fallback: Ot, target: t, session: e, host: s }),
    c = r
      ? new jt({ base: i.base, routes: At, trailing_slash: n, renderer: l })
      : null;
  Tt(i),
    o && (await l.start(o)),
    c &&
